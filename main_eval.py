...
# from mistral.model import Transformer as Transformer
...
def mmlu(model_path: str):
    ...
    # assert args.model_name == "mistral-7b", "Only support mistral-7b now"
    if args.model_name == "mistral-7b":
        args.model_name = 'mistral-7b-new-eval'
        print('evaluate normal mistral-7b-new-eval')
